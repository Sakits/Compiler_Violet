...
import Codegen.IR.IRInst.IRBinaryExpr;
import Codegen.IR.IRInst.IRBranch;
import Codegen.IR.IRInst.IRCall;
import Codegen.IR.IRInst.IRCmp;
import Codegen.IR.IRInst.IRGet;
import Codegen.IR.IRInst.IRJump;
import Codegen.IR.IRInst.IRLoad;
import Codegen.IR.IRInst.IRMove;
import Codegen.IR.IRInst.IRRet;
import Codegen.IR.IRInst.IRStore;
import Codegen.IR.IRInst.IRBinaryExpr.binary_op_type;
import Codegen.IR.IRInst.IRCmp.cmp_op_type;
import Codegen.IR.IRType.IRBool;
import Codegen.IR.IRType.IRChar;
import Codegen.IR.IRType.IRClass;
import Codegen.IR.IRType.IRInt;
import Codegen.IR.IRType.IRPointer;
import Codegen.IR.IRType.IRStr;
import Codegen.IR.IRType.IRType;
import Codegen.IR.IRType.IRVoid;
